...
window.Barryvanveen=window.Barryvanveen||{},$("document").ready(function(){window.Barryvanveen.smoothScrollToHash(),window.Barryvanveen.initScrollUp(),window.Barryvanveen.initClickableTableRows(),window.Barryvanveen.initAutosizeTextareas(),window.Barryvanveen.initMarkdownEditors()}),window.Barryvanveen.smoothScrollToHash=function(){$("a[href*=#]:not([href=#]):not([noscroll])").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var n=$(this.hash);if(n=n.length?n:$("[name="+this.hash.slice(1)+"]"),n.length)return $("html,body").animate({scrollTop:n.offset().top},500),!1}}),$("a[href*=#][noscroll]").click(function(n){location.hash=$(this).attr("href"),window.scrollTo(0,0),n.preventDefault()})},window.Barryvanveen.initScrollUp=function(){$.scrollUp({scrollName:"scrollUp",scrollDistance:300,scrollFrom:"top",scrollSpeed:300,easingType:"linear",animation:"fade",animationSpeed:200,scrollTrigger:!1,scrollTarget:!1,scrollText:"Terug naar boven",scrollTitle:!1,scrollImg:!1,activeOverlay:!1,zIndex:2147483647})},window.Barryvanveen.initClickableTableRows=function(){$(".js-clickable-row").mousedown(function(n){if(n.preventDefault(),2==n.which){var o=window.open($(this).data("href"),"_blank");return void(o&&o.focus())}window.document.location=$(this).data("href")})},window.Barryvanveen.initAutosizeTextareas=function(){autosize($("textarea"))},window.Barryvanveen.MarkdownEditor=function(n){var o=$(n),a=$("div[data-markdown-editor-name="+n.name+"]");this.updateMarkdownEditor=function(){a.html(markdown.toHTML(o.val()))},o.keyup(this.updateMarkdownEditor),this.updateMarkdownEditor()},window.Barryvanveen.initMarkdownEditors=function(){$("textarea.js-markdown-editor").each(function(n,o){window.Barryvanveen.editor=new window.Barryvanveen.MarkdownEditor(o)})};