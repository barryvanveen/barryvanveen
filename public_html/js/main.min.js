...
window.Barryvanveen=window.Barryvanveen||{},$("document").ready(function(){window.Barryvanveen.callTimer=[],window.Barryvanveen.smoothScrollToHash(),window.Barryvanveen.initScrollUp(),window.Barryvanveen.initClickableTableRows(),window.Barryvanveen.initAutosizeTextareas(),window.Barryvanveen.initMarkdownEditors(),window.Barryvanveen.initDatetimepickers(),window.Barryvanveen.initLogModal()}),window.Barryvanveen.smoothScrollToHash=function(){$("a[href*=#]:not([href=#]):not([noscroll])").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var n=$(this.hash);if(n=n.length?n:$("[name="+this.hash.slice(1)+"]"),n.length)return $("html,body").animate({scrollTop:n.offset().top},500),!1}}),$("a[href*=#][noscroll]").click(function(n){location.hash=$(this).attr("href"),window.scrollTo(0,0),n.preventDefault()})},window.Barryvanveen.initScrollUp=function(){$.scrollUp({scrollName:"scrollUp",scrollDistance:300,scrollFrom:"top",scrollSpeed:300,easingType:"linear",animation:"fade",animationSpeed:200,scrollTrigger:!1,scrollTarget:!1,scrollText:"Terug naar boven",scrollTitle:!1,scrollImg:!1,activeOverlay:!1,zIndex:2147483647})},window.Barryvanveen.initClickableTableRows=function(){$(".js-clickable-row").mousedown(function(n){if(n.preventDefault(),2==n.which){var a=window.open($(this).data("href"),"_blank");return void(a&&a.focus())}window.document.location=$(this).data("href")})},window.Barryvanveen.initAutosizeTextareas=function(){autosize($("textarea"))},window.Barryvanveen.abortPostQueue=function(n){$.ajaxq.abort(n)},window.Barryvanveen.MarkdownEditor=function(n){var a=$(n),e=$("div[data-markdown-editor-name="+n.name+"]"),o=a.attr("name");this.updateMarkdownEditor=function(){"undefined"!=typeof window.Barryvanveen.callTimer[o]&&clearTimeout(window.Barryvanveen.callTimer[o]),window.Barryvanveen.callTimer[o]=setTimeout(function(){Barryvanveen.abortPostQueue(a.attr("name")),$.postq(o,Barryvanveen.markdownToHtmlRoute,{markdown:a.val()},function(n){e.html(n.html),Prism.highlightAll()},"json")},1e3)},a.keyup(this.updateMarkdownEditor),this.updateMarkdownEditor()},window.Barryvanveen.initMarkdownEditors=function(){$("textarea.js-markdown-editor").each(function(n,a){window.Barryvanveen.editor=new window.Barryvanveen.MarkdownEditor(a)})},window.Barryvanveen.initDatetimepickers=function(){$(".js-datetimepicker").datetimepicker({locale:"nl",icons:{time:"icon icon--clock",date:"icon icon--calendar",up:"icon icon--arrowUp",down:"icon icon--arrowDown",previous:"icon icon--arrowLeft",next:"icon icon--arrowRight"}})},window.Barryvanveen.initLogModal=function(){$("#logModal").on("show.bs.modal",function(n){var a=$(n.relatedTarget),e=a.data("level"),o=a.data("text"),i=a.data("file"),r=a.data("stack"),t=$(this);t.find(".modal-title").html(e+": "+o),t.find(".modal-body").html("<small>In file "+i+"<br><br>"+r+"</small>")})};