...
window.LaravelInstall=window.LaravelInstall||{},$("document").ready(function(){window.LaravelInstall.smoothScrollToHash(),window.LaravelInstall.initSnackbar()}),window.LaravelInstall.smoothScrollToHash=function(){$("a[href*=#]:not([href=#]):not([noscroll])").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=$(this.hash);if(a=a.length?a:$("[name="+this.hash.slice(1)+"]"),a.length)return $("html,body").animate({scrollTop:a.offset().top},500),!1}}),$("a[href*=#][noscroll]").click(function(a){location.hash=$(this).attr("href"),window.scrollTo(0,0),a.preventDefault()})},window.LaravelInstall.initSnackbar=function(){if("undefined"!=typeof LaravelInstall.alert){var a={content:LaravelInstall.alert.message,style:"alert-"+LaravelInstall.alert.level,timeout:5e3};$.snackbar(a)}};